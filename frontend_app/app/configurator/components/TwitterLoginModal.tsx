  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
      <div className="bg-gray-800 p-6 rounded-xl max-w-md w-full mx-4 border border-gray-700">
        <h3 className="text-xl font-bold text-white mb-4">Connect with X or Lazor</h3>
        <p className="text-gray-300 mb-6">
          Connect your account to save your agent configurations and access additional features.
        </p>
