...
async function getVaultAvailableBalance(agent: SolanaAgentKit, vault: string) {
  try {
    ...
    const error = e as { message: string };
    throw new Error(`Failed to get vault available balance: ${error.message}`);
  }
}
...
export async function createVault(
  ...
  try {
    ...
    const error = e as { message: string };
    throw new Error(`Failed to create Drift vault: ${error.message}`);
  }
}
...
export async function updateVaultDelegate(
  ...
  try {
    ...
    const error = e as { message: string };
    throw new Error(`Failed to update vault delegate: ${error.message}`);
  }
}
...
export async function updateVault(
  ...
  try {
    ...
    const error = e as { message: string };
    throw new Error(`Failed to update Drift vault: ${error.message}`);
  }
}
...
export async function depositIntoVault(
  ...
  try {
    ...
    const error = e as { message: string };
    throw new Error(`Failed to deposit into Drift vault: ${error.message}`);
  }
}
...
export async function requestWithdrawalFromVault(
  ...
  try {
    ...
    const error = e as { message: string };
    throw new Error(`Failed to request withdrawal from Drift vault: ${error.message}`);
  }
}
...
export async function withdrawFromDriftVault(
  ...
  try {
    ...
    const error = e as { message: string };
    throw new Error(`Failed to redeem tokens from Drift vault: ${error.message}`);
  }
}
...
async function getIsOwned(agent: SolanaAgentKit, vault: string) {
  try {
    ...
    const error = e as { message: string };
    throw new Error(`Failed to check if vault is owned: ${error.message}`);
  }
}
...
export async function tradeDriftVault(
  ...
  try {
    ...
    const error = e as { message: string };
    throw new Error(`Failed to trade with Drift vault: ${error.message}`);
  }
}
