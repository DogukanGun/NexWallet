...
class CdpBaseTool(BaseTool):
    name:str = "CDP_Base_Agent_Tool"
    description:str = "Whenever an user request is made about Base Blockchain, use this tool"
